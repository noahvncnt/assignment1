...
Test 63: print_tables 5 -> [SKIPPED - formatted output]
...
Test 64: print_tables 0 -> [SKIPPED - formatted output]
...
Test 65: print_tables 1 -> [SKIPPED - formatted output]
...
Test 66: print_tables 7 -> [SKIPPED - formatted output]
...
Test 67: print_tables 15 -> [SKIPPED - formatted output]
...
Test 68: print_tables 8 -> [SKIPPED - formatted output]
...
Test 69: print_tables 16 -> [SKIPPED - formatted output]
...
Test 70: print_tables 32 -> [SKIPPED - formatted output]
...
Test 71: print_tables 255 -> [SKIPPED - formatted output]
...
AND with 0xFF: Binary=0 Octal=0 Decimal=0 Hex=0
Test 72: print_tables 256 -> [SKIPPED - formatted output]
...
AND with 0xFF: Binary=11111111 Octal=377 Decimal=255 Hex=FF
Test 73: print_tables 511 -> [SKIPPED - formatted output]
...
Test 74: print_tables 1000 -> [SKIPPED - formatted output]
...
AND with 0xFF: Binary=11111111 Octal=377 Decimal=255 Hex=FF
Test 75: print_tables 65535 -> [SKIPPED - formatted output]
...
AND with 0xFF: Binary=11111111 Octal=377 Decimal=255 Hex=FF
Test 76: print_tables 4294967295 -> [SKIPPED - formatted output]
...
## Notes
sub_convert uses an overflow-safe loop when finding the largest power of the base:
```c
uint32_t power = 1;
while (power <= n / (uint32_t)base) power *= (uint32_t)base;
```

Lines in tests.txt that have print_tables are formatted output checks; they are executed but reported as [SKIPPED – formatted output] in the test summary.

Keep div_convert and sub_convert free of printf to avoid cluttering the output.
